...
import secretariasPlanejamentoUrbanoRoutes from './routes/secretarias-planejamento-urbano';
import secretariasServicosPublicosRoutes from './routes/secretarias-servicos-publicos';
import secretariasTurismoRoutes from './routes/secretarias-turismo';
...
app.use('/api/admin/secretarias/planejamento-urbano', secretariasPlanejamentoUrbanoRoutes);
app.use('/api/admin/secretarias/servicos-publicos', secretariasServicosPublicosRoutes);
app.use('/api/admin/secretarias/turismo', secretariasTurismoRoutes);
