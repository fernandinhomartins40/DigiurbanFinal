...
import { Heart, Users, Home, Clock, CheckCircle } from 'lucide-react';

export default function AssistenciaSocialDashboard() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Dashboard - Assistência Social</h1>
