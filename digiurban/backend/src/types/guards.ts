...
export function ensureTenant(req: Request): asserts req is Request & { tenantId: string } {
  if (!req.tenantId) {
...
export function assertTenantId(req: Request): asserts req is Request & { tenantId: string } {
  if (!req.tenantId) {
